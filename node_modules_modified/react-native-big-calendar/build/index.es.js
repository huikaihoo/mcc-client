...
var HourGuideColumn = memo(function (_a) {
    ...
    return (createElement(View, { style: { height: cellHeight } },
        createElement(Text, { style: commonStyles.guideText }, formatHour(hour, ampm))));
...
var CalendarBody = memo(function (_a) {
    ...
    return (createElement(ScrollView, __assign({ style: [
        ...
        createElement(View, __assign({ style: isRTL ? [styles$1.bodyRTL] : [styles$1.body] }, (Platform.OS === 'web' ? panResponder.panHandlers : {})),
            createElement(View, { style: [commonStyles.hourGuide] }, hours.map(function (hour) { return (createElement(HourGuideColumn, { key: hour, cellHeight: cellHeight, hour: hour, ampm: ampm })); })),
            dateRange.map(function (date) { return (createElement(View, { style: styles$1.dayContainer, key: date.toString() },
                ...
                dayJsConvertedEvents
                    ...
                    .map(function (event) { return (createElement(CalendarEvent, { key: "" + event.start + event.title, event: event, onPressEvent: onPressEvent, eventCellStyle: eventCellStyle, showTime: showTime, eventCount: getCountOfEventsAtEvent(event, dayJsConvertedEvents), eventOrder: getOrderOfEvent(event, dayJsConvertedEvents), overlapOffset: overlapOffset })); }),
                isToday(date) && !hideNowIndicator && (createElement(View, { style: [styles$1.nowIndicator, { top: getRelativeTopInDay(now) + "%" }] })))); }))));
});
...
var CalendarHeader = memo(function (_a) {
    ...
    return (createElement(View, { style: [isRTL ? styles$2.containerRTL : styles$2.container, style] },
...
var Calendar = memo(function (_a) {
    ...
    var _m = useState(dayjs(date)), targetDate = _m[0], setTargetDate = _m[1];
    useEffect(function () {
        if (date) {
    ...
    return (createElement(Fragment, null,
        ...
        createElement(CalendarBody, __assign({}, commonProps, { containerHeight: height, dayJsConvertedEvents: daytimeEvents, eventCellStyle: eventCellStyle, hideNowIndicator: hideNowIndicator, overlapOffset: overlapOffset, scrollOffsetMinutes: scrollOffsetMinutes, ampm: ampm, showTime: showTime, onPressCell: onPressCell, onPressEvent: onPressEvent, onSwipeHorizontal: onSwipeHorizontal }))));
});
